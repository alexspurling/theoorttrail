...
Elm.Location.Galaxy.make = function (_elm) {
   ...
   var getPlanetPosition = F2(function (index,
   planetPositions) {
      return A2($Maybe.withDefault,
...
Elm.Main.make = function (_elm) {
   ...
   var StartTravel = function (a) {
      return {ctor: "StartTravel"
             ,_0: a};
   };
   var nearestPlanetsView = F2(function (address,
   planet) {
      return A2($Html.div,
      _L.fromArray([]),
                      ...
                      return function () {
                         ...
                         {case "_Tuple2":
                            return A2($Html.li,
                              ...
                              _L.fromArray([$Html.text(A2($Basics._op["++"],
                              _v2._0.name,
                              displayDistance(_v2._1)))]));}
                         _U.badCase($moduleName,
                         "on line 144, column 13 to 113");
                      }();
                   },
   ...
   model) {
      return function () {
         var componentHtml = function () {
            ...
            switch (_v6.ctor)
            {case "Default":
               return $Location$Planet.stats(model.visiting);
               case "Nearby":
               return A2(nearestPlanetsView,
                 address,
                 model.visiting);}
            _U.badCase($moduleName,
         ...
         _L.fromArray([A2($Html.div,
                      ...
                      _L.fromArray([$Ship$Ship.view(model.ship)
                                   ,A2($Html.div,
                                   _L.fromArray([$Html$Attributes.$class("panel")]),
                                   _L.fromArray([$Location$Planet.view(model.visiting)
                                                ,componentHtml
...
Elm.Util = Elm.Util || {};
Elm.Util.ArrayUtil = Elm.Util.ArrayUtil || {};
Elm.Util.ArrayUtil.make = function (_elm) {
   "use strict";
   _elm.Util = _elm.Util || {};
   _elm.Util.ArrayUtil = _elm.Util.ArrayUtil || {};
   if (_elm.Util.ArrayUtil.values)
   return _elm.Util.ArrayUtil.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "Util.ArrayUtil",
   $Array = Elm.Array.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   ...
   var randomArrayElement = F3(function (seed,
   array,
   $default) {
      return function () {
         var $ = A2($Random.generate,
         ...
         randomIndex = $._0,
         seed$ = $._1;
         var randomElement = A2($Maybe.withDefault,
         $default,
         A2($Array.get,
         randomIndex,
         array));
